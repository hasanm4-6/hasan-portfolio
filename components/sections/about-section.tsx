    ...
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background to-muted/20">
      <div className="max-w-6xl mx-auto">
          ...
          <Card className="p-6 sm:p-8">
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              <p className="text-base leading-relaxed">
                My core strength lies in the <strong>MERN stack</strong>{' '}
                (MongoDB, Express.js, React.js, Node.js), complemented by{' '}
                <strong>Python</strong>, <strong>FastAPI</strong>, and working
                knowledge of Django. I don't just write code—I design systems,
                shape APIs, and think in terms of scalability, performance, and
                long-term maintainability.
              </p>
              <p className="text-base leading-relaxed">
                I've spent over <strong>10 months</strong> working within real
                software engineering environments, collaborating with clients
                and teams, translating business requirements into technical
                solutions, and shipping features that actually get used.
              </p>
              <p className="text-base leading-relaxed">
        ...
        <Card className="p-6 sm:p-8 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 border-blue-200 dark:border-blue-800">
          <h3 className="font-semibold mb-4 text-lg">My Engineering Philosophy</h3>
          <ul className="space-y-3 text-sm mb-4">
            <li className="flex items-start gap-3">
              <span className="text-primary text-lg mt-0.5">→</span>
              <div>
                <strong>Solve the problem first</strong>
                <p className="text-muted-foreground text-xs mt-0.5">Understand what needs to be built before writing code</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-primary text-lg mt-0.5">→</span>
              <div>
                ...
                <p className="text-muted-foreground text-xs mt-0.5">Code is read more often than written; clarity is paramount</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-primary text-lg mt-0.5">→</span>
              <div>
                ...
                <p className="text-muted-foreground text-xs mt-0.5">Premature optimization is the root of all evil</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-primary text-lg mt-0.5">→</span>
              <div>
                ...
                <p className="text-muted-foreground text-xs mt-0.5">Get something out there, learn from real usage, iterate</p>
              </div>
            </li>
          </ul>
          <p className="text-sm text-muted-foreground leading-relaxed">
            I value clean architecture, predictable APIs, and user-centric
            design. I'm constantly learning, questioning patterns, and refining
            my craft—because good software isn't written once, it's evolved.
          </p>
        </Card>
